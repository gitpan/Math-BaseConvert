...
our $VERSION     = '1.7'; our $PTVR = $VERSION; $PTVR =~ s/^\d+\.\d+\.//; # Please see `perldoc Time::PT` for an explanation of $PTVR.
...
This documentation refers to version 1.7 of Math::BaseConvert, which was released on Tue Jun 15 16:17:20:14 2010.
